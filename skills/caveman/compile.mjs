...
//
// Every skill body lives once at public/skills/<id>/SKILL.md. registry.json
...
function generatedBody(selected, destination) {
  ...
  return `// GENERATED by public/skills/compile.mjs from public/skills/*/SKILL.md + registry.json — DO NOT EDIT.
...
function nativeTypeScript() {
  ...
  return `// GENERATED by public/skills/compile.mjs from native-core.md + native SKILL.md files — DO NOT EDIT.
...
if (existsSync(webDir)) {
  ...
  console.error(`compiled ${webSkills.length} agent skill(s) into cloud/web/lib/agent-skills.generated.ts`);
} else {
  console.error(`cloud/web not present — skipped web embed (${webSkills.length} skill(s) validated)`);
}
